...
class TestBridgeIntegration:
    ...
    def test_end_to_end_simple_conversation(self, test_config, anthropic_samples, openai_samples):
        ...
        with patch.object(bridge.openai_client, 'create_chat_completion', return_value=mock_response):
            ...
            # Verify the response has correct Anthropic format
    ...
    def test_end_to_end_with_system_message(self, test_config, anthropic_samples, openai_samples):
        """Test conversation with system message"""
        bridge = AnthropicOpenAIBridge(config_manager=test_config)
        
        mock_response = openai_samples["simple_response"]
        
        with patch.object(bridge.openai_client, 'create_chat_completion', return_value=mock_response) as mock_client:
    ...
    def test_end_to_end_multi_turn(self, test_config, anthropic_samples, openai_samples):
    ...
    def test_error_handling(self, test_config):
        ...
        with patch.object(bridge.openai_client, 'create_chat_completion', return_value=error_response):
